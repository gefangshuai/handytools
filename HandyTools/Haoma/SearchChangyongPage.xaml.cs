...
namespace HandyTools.Haoma
{
    ...
    /// </summary>
    public sealed partial class SearchChangyongPage : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();
        private List<Changyong> listChangyongs; 
        public SearchChangyongPage()
        {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            listChangyongs = e.Parameter as List<Changyong>;
            if (listChangyongs != null)
            {
                DataListView.ItemsSource = listChangyongs;
            }
        }
        ...
        private void DataListView_OnItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            if (item != null) PhoneCallManager.ShowPhoneCallUI(item.Value.Replace("-", ""), item.Name);
        }
